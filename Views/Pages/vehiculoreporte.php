...
<div class="container mt-5">
    <div class="card shadow-lg">
        <div class="card-body">
            <h2 class="card-title text-center py-3" style="font-weight:bold">Reporte de Vehiculos</h2>
        ...
        try {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    doc.text('Reporte de Vehiculos', 105, 32, null, null, 'center');

                    // Tabla con autoTable
                    const tableColumn = ["Placa", "Stock", "Precio", "Marca", "Modelo", "Color"];
                    const tableRows = [];
