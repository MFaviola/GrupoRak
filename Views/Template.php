...
<head>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css">
    ...
    <!-- DataTables -->
    <link rel="stylesheet" href="Views/Resources/plugins/datatables-bs4/css/dataTables.bootstrap4.css">
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
     ...
     <section class="content">
      ...
      <?php 
    if (isset($_GET["Pages"])) {
      if ($_GET["Pages"] == "facturas" || $_GET["Pages"] == "inventario" || $_GET["Pages"] == "cliente"   || $_GET["Pages"] == "empleados") {
...
<script src="Views/Resources/plugins/datatables-bs4/js/dataTables.bootstrap4.js"></script>
