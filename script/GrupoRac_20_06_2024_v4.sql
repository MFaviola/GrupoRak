...
INSERT INTO `vent_tbapartados` VALUES (1,'2024-06-16 00:00:00',1,1,1500.0000,'2024-06-20 00:00:00',1,NULL,'2024-06-20 00:00:00',NULL,_binary '');
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Apartado_Insertar`(
    IN p_Apa_Fecha DATETIME,
    IN p_Mpg_ID INT,
    IN p_Cli_Id INT,
    IN p_Apa_Monto decimal(19,4),
    IN p_Apa_Fecha_Caducacion datetime, 
    IN p_Apa_Creacion INT,
    OUT p_Apa_ID INT
)
BEGIN
    ...
    VALUES (p_Apa_Fecha, p_Mpg_ID, p_Cli_Id,p_Apa_Monto,p_Apa_Fecha_Caducacion, p_Apa_Creacion, CURDATE(), 1);

    SET p_Apa_ID = LAST_INSERT_ID();
...
BEGIN
SELECT Veh_Placa, Veh_Color, Veh_Stock, FORMAT((Veh_Precio),2) Veh_Precio, VE.Mod_Id, Mod_Descripcion, Mar_Descripcion
...
Sed_Descripcion, Ciu_Descripcion, concat(cli_nombre, ' ', cli_Apellido) cli_nombre, 
        FORMAT(Vdt_PrecioVenta, 2) Vdt_PrecioVenta, FORMAT((Vdt_PrecioVenta),2) subtotal,
...
-- Dump completed on 2024-06-20 11:45:47
